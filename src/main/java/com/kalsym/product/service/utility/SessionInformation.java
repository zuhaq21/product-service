...
public class SessionInformation {
    ...
    public static MySQLUserDetails getSessionInfo(String logprefix) {
        ...
        Logger.application.info(Logger.pattern, ProductServiceApplication.VERSION, logprefix, "Token userRole:" + mysqlUserDetails.getRole()+" ownerId:"+mysqlUserDetails.getOwnerId()+" isSuperUser:"+mysqlUserDetails.getIsSuperUser(), "");
